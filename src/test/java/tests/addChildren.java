 ...
 * @param <loginPage>
 */
public class addChildren extends testBase {
	
	 @DataProvider(name = "addChildTest")
		public static Object[][] loginData() throws Exception {
		
			ExcelUtils loginData = new ExcelUtils();
			Object[][] testObjArray = loginData.getTableArray(".\\src\\test\\java\\testUtils\\datasheet.xlsx", "addChild");
	...
	public void setupBeforeClass() {
		extentTest = reporter.createTest("Verify addChild Test", "Verify addChild from Menu Options");
	}
	 ...
	 * @throws Exception 
	 */
	@Test(dataProvider = "addChildTest")
	public void clickOnAllMenuOptions(String Username, String Password, String Firstname, String Middlename, String Lastname, 
			String dob, String gender, String childemail ) throws Exception {
		...
		accountMenuPages.chidrenPageNav();
		accountMenuPages.childrenPage(Firstname, Middlename, Lastname, dob, gender, childemail);
		//accountMenuPages.selectDateOfBirth(dob, gender, childemail);
