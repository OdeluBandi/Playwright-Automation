 ...
 fis = new FileInputStream(xlFilePath);
    ...
    public  Object[][] getTableArray(String FilePath, String SheetName) throws Exception {   
        ...
        FileInputStream fis = new FileInputStream(FilePath);
            ...
            workbook = new XSSFWorkbook(fis);       // Access the required test data sheet
        ...
        int totalCols = getColumnCount(FilePath,SheetName);      // you can write a function as well to get Column count
...
public static String getCellData(int rowNum,int column) throws Exception
	...
	public Object[][] getTableArray2 (String FilePath, String SheetName) throws Exception {
		
			String[][] tabArray = null;
		 FileInputStream file = new FileInputStream(FilePath);         
         workbook = new XSSFWorkbook(file);       // Access the required test data sheet 
         sheet = workbook.getSheet(SheetName);
         ...
         for (int i = 0; i < noOfRows-1; i++) {
        	...
        	tabArray [i][j] = df.formatCellValue(sheet.getRow(i+1).getCell(j));
